...
const refreshToken = "1/mnSXA-PbIO_WEdkd3tmCb9MjTkDw4NZe1184679jdoYmW-qt_-H3cetLFuHFF1_V"
const googleId = "113582906180370887650"
const name = "Hristo Todorov"
const email = "oci@todorov.io"
...
describe('Auth', () => {
  ...
  describe('POST /auth', () => {
    it('should auth with expired token when security off', async () => {
      console.log("2312")
